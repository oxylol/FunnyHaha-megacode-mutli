...
try {
    ...
    Write-Host "  OK - MelonLoader DLLs copied" -ForegroundColor Green
} catch {
    Write-Host "  FAILED - Could not copy MelonLoader DLLs" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "  OK - Managed DLLs copied" -ForegroundColor Green
} catch {
    Write-Host "  FAILED - Could not copy Managed DLLs" -ForegroundColor Red
}
...
if (Test-Path "$SR2_PATH\Mods\SR2E.dll") {
    ...
    Write-Host "  OK - SR2E.dll copied" -ForegroundColor Green
} else {
